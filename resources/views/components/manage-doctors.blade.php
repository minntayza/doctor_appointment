        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="flex justify-between items-center mb-8">
                <div>
                    ...
                    <p class="mt-2 text-gray-600">Manage and organize your medical staff</p>
                </div>

                <a href="/add-doctor" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200 shadow-sm">
            ...
            <!-- Search Bar -->
            <div class="mb-8">
                <form method="GET" action="/manage-doctors" class="max-w-md">
                    <div class="relative">
                        <input type="text"
                            name="search"
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-200">
                                    ...
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10">
                                            <div class="h-10 w-10 rounded-full bg-blue-100 flex items-center justify-center">
                                                <span class="text-blue-600 font-medium">{{ substr($doctor->name, 0, 1) }}</span>
                                            </div>
                                        </div>
                                        <div class="ml-4">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <div class="flex items-center justify-center space-x-2">
                                        ...
                                        <form method="POST" action="/manage-doctors/{{$doctor->id}}/delete" onsubmit="return confirm('Are you sure you want to delete this doctor?');">
                                            @csrf
                                            @method('DELETE')
