...
<div class="bg-white rounded-xl shadow-lg p-6">
    <div class="mb-6">
        <h3 class="text-2xl font-bold text-gray-900">
            ...
            <span class="block text-sm font-medium text-gray-500 mt-1">Select your preferred appointment time</span>
        </h3>
    </div>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4">
                ...
                @empty
                    <div class="col-span-full py-8 text-center">
                        ...
                        <p class="mt-1 text-sm text-gray-500">Currently, there are no available time slots for this doctor.</p>
                    </div>
                @endforelse
            </div>
        </div>
